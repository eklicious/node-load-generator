...
# Param 5: max member id required by the node app server
...
echo $( callCurlParallel $1 $2 $3 $4/pega/member/$5 )
echo $( callCurlParallel $1 $2 $3 $4/pega/member/update/$5 )
echo $( callCurlParallel $1 $2 $3 $4/pega/member/add/$5 )
